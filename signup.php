		...
		<div class="container">
			<div class="row">
				<div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2 text-center">
					<h1>Help join the fight!</h1>
					<p class="lead">
						Signing up with Greenbase and our parent organization the Climate Collaborative will get you access to the entire directory
					of other users related to climate change. You also get these other benefits: <ul class="expanding-ul">
